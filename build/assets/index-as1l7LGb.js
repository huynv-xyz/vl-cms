import{j as t,B as p,b1 as n}from"./index-BpacLYah.js";import{u as e}from"./useQuery-i6EP5Xum.js";import{g as m}from"./export-BphAPdrl.js";import{E as s,a as x}from"./export-items-WgPRqy-9.js";import{P as d}from"./page-section-Bl3iR4Pa.js";import{P as l}from"./printer-B6in6brN.js";import"./crud-D3tsnRM6.js";import"./main-BeSBJbUO.js";import"./skeleton-D6M6heo2.js";import"./loader-circle-BI5zxkmN.js";import"./createLucideIcon-D6bm2S_i.js";const b=`
@media print {
  html, body {
    margin: 0 !important;
    padding: 0 !important;
...
`;function g({id:r}){const i=e({queryKey:["export-detail",r],queryFn:()=>m(r),enabled:Number.isFinite(r)&&r>0}),a=i.data?.data??i.data;return t.jsx(d,{isLoading:i.isLoading,error:i.error,data:a,title:"Phiếu xuất kho",showBack:!0,actions:t.jsxs(p,{variant:"outline",size:"sm",onClick:()=>window.print(),children:[t.jsx(l,{className:"h-4 w-4 mr-1.5"}),"In phiếu"]}),children:o=>t.jsxs("div",{className:"max-w-5xl mx-auto print:m-0 print:max-w-none",children:[t.jsx("style",{children:b}),t.jsxs("div",{id:"export-print-area",className:"bg-white rounded-md shadow-sm border border-gray-200 p-5 print:shadow-none print:border-none print:p-0",children:[t.jsx(s,{data:o}),t.jsx(x,{data:o,items:o.items??[]})]})]})})}function N(){const{id:r}=n.useParams();return t.jsx(g,{id:Number(r)})}export{N as component};
