    ...
    return (
        <CrudFormDialog<EmployeeFormValues, UpdateEmployeeRequest, unknown>
            ...
            defaultValues={{
                ...
                personal_insurance_from: employee.personal_insurance_from ?? "",
                personal_insurance_to: employee.personal_insurance_to ?? "",
                personal_bhxh: employee.personal_bhxh === 1 ? 1 : 0,
                personal_bhyt: employee.personal_bhyt === 1 ? 1 : 0,
                personal_bhtn: employee.personal_bhtn === 1 ? 1 : 0,
                personal_kpcd: employee.personal_kpcd === 1 ? 1 : 0,
            ...
            mapFormToRequest={(values) => ({
                ...
                personal_insurance_from: values.personal_insurance_from || null,
                personal_insurance_to: values.personal_insurance_to || null,
                personal_bhxh: values.personal_bhxh === 1 ? 1 : 0,
                personal_bhyt: values.personal_bhyt === 1 ? 1 : 0,
                personal_bhtn: values.personal_bhtn === 1 ? 1 : 0,
                personal_kpcd: values.personal_kpcd === 1 ? 1 : 0,
