...
export default function InventorySummaryPage() {
    ...
    const {
        ...
        [
            ...
            "summary_status",
            "opening_quantity_op",
            "opening_quantity_value",
            "opening_value_op",
            "opening_value_value",
            "inbound_quantity_op",
            "inbound_quantity_value",
            "inbound_value_op",
            "inbound_value_value",
            "outbound_quantity_op",
            "outbound_quantity_value",
            "avg_issue_unit_cost_op",
            "avg_issue_unit_cost_value",
            "outbound_value_op",
            "outbound_value_value",
            "closing_quantity_op",
    ...
    const tableFilters: SummaryFilters = {
        ...
        warehouse_code_text_op: singleFilters.warehouse_code_text_op as SummaryFilters["warehouse_code_text_op"],
        warehouse_name_text: singleFilters.warehouse_name_text,
        warehouse_name_text_op: singleFilters.warehouse_name_text_op as SummaryFilters["warehouse_name_text_op"],
        ...
        opening_quantity_op: singleFilters.opening_quantity_op as SummaryFilters["opening_quantity_op"],
        opening_quantity_value: singleFilters.opening_quantity_value,
        opening_value_op: singleFilters.opening_value_op as SummaryFilters["opening_value_op"],
        opening_value_value: singleFilters.opening_value_value,
        inbound_quantity_op: singleFilters.inbound_quantity_op as SummaryFilters["inbound_quantity_op"],
        inbound_quantity_value: singleFilters.inbound_quantity_value,
        inbound_value_op: singleFilters.inbound_value_op as SummaryFilters["inbound_value_op"],
        inbound_value_value: singleFilters.inbound_value_value,
        outbound_quantity_op: singleFilters.outbound_quantity_op as SummaryFilters["outbound_quantity_op"],
        outbound_quantity_value: singleFilters.outbound_quantity_value,
        avg_issue_unit_cost_op: singleFilters.avg_issue_unit_cost_op as SummaryFilters["avg_issue_unit_cost_op"],
        avg_issue_unit_cost_value: singleFilters.avg_issue_unit_cost_value,
        outbound_value_op: singleFilters.outbound_value_op as SummaryFilters["outbound_value_op"],
        outbound_value_value: singleFilters.outbound_value_value,
        ...
        closing_value_op: singleFilters.closing_value_op as SummaryFilters["closing_value_op"],
    ...
    const { data, isLoading, error } = usePaginatedList(
        [
            ...
            singleFilters.opening_quantity_op,
            singleFilters.opening_quantity_value,
            singleFilters.opening_value_op,
            singleFilters.opening_value_value,
            singleFilters.inbound_quantity_op,
            singleFilters.inbound_quantity_value,
            singleFilters.inbound_value_op,
            singleFilters.inbound_value_value,
            singleFilters.outbound_quantity_op,
            singleFilters.outbound_quantity_value,
            singleFilters.avg_issue_unit_cost_op,
            singleFilters.avg_issue_unit_cost_value,
            singleFilters.outbound_value_op,
            singleFilters.outbound_value_value,
        ...
        listInventorySummarys,
        {
            ...
            opening_quantity_op: requestFilters.opening_quantity_op,
            opening_quantity_value: requestFilters.opening_quantity_value,
            opening_value_op: requestFilters.opening_value_op,
            opening_value_value: requestFilters.opening_value_value,
            inbound_quantity_op: requestFilters.inbound_quantity_op,
            inbound_quantity_value: requestFilters.inbound_quantity_value,
            inbound_value_op: requestFilters.inbound_value_op,
            inbound_value_value: requestFilters.inbound_value_value,
            outbound_quantity_op: requestFilters.outbound_quantity_op,
            outbound_quantity_value: requestFilters.outbound_quantity_value,
            avg_issue_unit_cost_op: requestFilters.avg_issue_unit_cost_op,
            avg_issue_unit_cost_value: requestFilters.avg_issue_unit_cost_value,
            outbound_value_op: requestFilters.outbound_value_op,
            outbound_value_value: requestFilters.outbound_value_value,
                ...
                <SummaryTable
                    ...
                    filters={tableFilters}
                        ...
                        setSingleFilters({
                            ...
                            opening_quantity_op: next.opening_quantity_op,
                            opening_quantity_value: next.opening_quantity_value,
                            opening_value_op: next.opening_value_op,
                            opening_value_value: next.opening_value_value,
                            inbound_quantity_op: next.inbound_quantity_op,
                            inbound_quantity_value: next.inbound_quantity_value,
                            inbound_value_op: next.inbound_value_op,
                            inbound_value_value: next.inbound_value_value,
                            outbound_quantity_op: next.outbound_quantity_op,
                            outbound_quantity_value: next.outbound_quantity_value,
                            avg_issue_unit_cost_op: next.avg_issue_unit_cost_op,
                            avg_issue_unit_cost_value: next.avg_issue_unit_cost_value,
                            outbound_value_op: next.outbound_value_op,
                            outbound_value_value: next.outbound_value_value,
